...
.. code-block:: console
    ...
    $ git clone git://github.com/{{ github_username }}/{{ project_slug }}

Or download the `tarball`_:

.. code-block:: console

    $ curl -OJL https://github.com/{{ github_username }}/{{ project_slug }}/tarball/master
...
.. _Github repo: https://github.com/{{ github_username }}/{{ project_slug }}
.. _tarball: https://github.com/{{ github_username }}/{{ project_slug }}/tarball/master
